# Based on
# https://github.com/espressif/esp-docs/blob/master/src/esp_docs/generic_extensions/google_analytics.py
...
def google_analytics_embed(app, pagename, templatename, context, doctree):
    ...
    # Prepend the google analytics to the HTML metatags (which will be passed
    # to the sphinx templating engine)
